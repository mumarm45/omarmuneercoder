...
describe('resumeStore — Projects', () => {
  ...
  it('updates a project', () => {
    const { result } = renderHook(() => useResumeStore());
    act(() => {
      result.current.addProject({ ...project, id: 99 });
    });
    act(() => {
      result.current.updateProject({ ...project, id: 99, name: 'Updated' });
    });
  ...
  it('deletes a project', () => {
    const { result } = renderHook(() => useResumeStore());
    act(() => {
      result.current.addProject({ ...project, id: 77 });
    });
    act(() => {
      result.current.deleteProject(77);
    });
...
describe('resumeStore — Certifications', () => {
  ...
  it('adds a certification', () => {
    ...
    act(() => {
      result.current.addCertification(cert);
    });
  ...
  it('updates a certification', () => {
    const { result } = renderHook(() => useResumeStore());
    act(() => {
      result.current.addCertification({ ...cert, id: 11 });
    });
    act(() => {
      result.current.updateCertification({ ...cert, id: 11, name: 'GCP Certified' });
    });
    expect(result.current.resumeData.certifications?.find((c) => c.id === 11)?.name).toBe(
      'GCP Certified'
    );
  });
  ...
  it('deletes a certification', () => {
    const { result } = renderHook(() => useResumeStore());
    act(() => {
      result.current.addCertification({ ...cert, id: 12 });
    });
    act(() => {
      result.current.deleteCertification(12);
    });
...
describe('resumeStore — Languages', () => {
  ...
  it('updates a language', () => {
    const { result } = renderHook(() => useResumeStore());
    act(() => {
      result.current.addLanguage({ ...lang, id: 21 });
    });
    act(() => {
      result.current.updateLanguage({ ...lang, id: 21, proficiency: 'Native' });
    });
    expect(result.current.resumeData.languages?.find((l) => l.id === 21)?.proficiency).toBe(
      'Native'
    );
  });
  ...
  it('deletes a language', () => {
    const { result } = renderHook(() => useResumeStore());
    act(() => {
      result.current.addLanguage({ ...lang, id: 22 });
    });
    act(() => {
      result.current.deleteLanguage(22);
    });
...
describe('resumeStore — Awards', () => {
  ...
  it('updates an award', () => {
    const { result } = renderHook(() => useResumeStore());
    act(() => {
      result.current.addAward({ ...award, id: 31 });
    });
    act(() => {
      result.current.updateAward({ ...award, id: 31, title: 'Team Award' });
    });
  ...
  it('deletes an award', () => {
    const { result } = renderHook(() => useResumeStore());
    act(() => {
      result.current.addAward({ ...award, id: 32 });
    });
    act(() => {
      result.current.deleteAward(32);
    });
