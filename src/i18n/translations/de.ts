...
export const de: Translation = {
  ...
  hobbiesIntro:
    'Neben dem Programmieren glaube ich, dass körperliche Aktivität essenziell für die mentale Gesundheit und Produktivität ist. Das hält mich im Gleichgewicht:',
  hobbyProgramming: 'Programmieren',
  hobbyProgrammingDesc:
    'Ich liebe es, neue Technologien zu erkunden, Nebenprojekte zu entwickeln und zu Open Source beizutragen. Programmieren ist nicht nur mein Beruf – es ist meine Leidenschaft.',
  hobbyRunning: 'Laufen',
  hobbyRunningDesc:
    'Laufen befreit meinen Kopf und fördert die Kreativität. Ob morgendliches Joggen oder lange Wochenendläufe – es hilft mir, fokussiert und energiegeladen zu bleiben.',
  hobbyFitness: 'Körperliche Fitness',
  hobbyFitnessDesc:
    'Ein gesunder Körper unterstützt einen gesunden Geist. Regelmäßiges Training hilft mir, konzentriert zu bleiben, Stress abzubauen und produktiv zu arbeiten.',
};
